...
{
    [DbContext(typeof(TaskWriteOnlyContext))]
    [Migration("20241017110957_InitialProjectionDb")]
    partial class InitialProjectionDb
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TaskService.Domain.Projections.GlobalTaskProjection", b =>
                {
                    ...
                    b.ToTable("GlobalTaskProjections");
                });
            ...
            modelBuilder.Entity("TaskService.Domain.Projections.SentToCheckTaskProjection", b =>
                {
                    ...
                    b.ToTable("SentToCheckTaskProjections");
                });
